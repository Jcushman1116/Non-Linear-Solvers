...
for sigma = 1:5 
    ...
    [root, progress, iterations] = RegulaFalsi_Method(scaled_f,((alpha+rho)/2),3,num_trials);
    fprintf("root found: %f |  Iterations: %d \n", root, iterations);
    fprintf("Scaled RF Iteration Progress \n"); 
    disp(progress); 
    ...
    % RF 4a
    fprintf("Scaled RF behavior for x0 = eta and x1 < eta \n");
    [root, progress, iterations] = RegulaFalsi_Method(scaled_f,eta,eta-1,num_trials);
    fprintf("root found: %f |  Iterations: %d \n", root, iterations);
    fprintf("Scaled RF Iteration Progress \n"); 
    disp(progress); 
    ...
    % RF 5a
    fprintf("Scaled RF behavior for  x0 = alpha and x1 < alpha \n");
    [root, progress, iterations] = RegulaFalsi_Method(scaled_f,alpha,alpha-1,num_trials);
    fprintf("root found: %f |  Iterations: %d \n", root, iterations);
    fprintf("Scaled RF Iteration Progress \n"); 
    disp(progress); 
